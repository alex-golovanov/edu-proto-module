...
const Start = () => {
  return (
    <>
      <Button variant="contained" color="primary" component={NavLink} to="/module/text-task">
        Text task
      </Button>
      <Button variant="contained" color="primary" component={NavLink} to="/module/video-task">
        Video task
      </Button>
    </>
  )
